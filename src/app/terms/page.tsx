...
export default function TermsPage() { return <LegalPage title="Website terms" intro="Plain-language website terms from Injectox Clinic Ltd, trading as Injectox Clinic, separate from the treatment and booking terms shown by the appointment provider." sections={[
