...
export const metadata: Metadata = pageMetadata({ title: "Shop — Coming Soon", description: "A future curated edit of Injectox Clinic skincare and aftercare.", path: "/shop", index: false });
