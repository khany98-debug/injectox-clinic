...
export const metadata: Metadata = pageMetadata({ title: "Privacy Policy", description: "How Injectox Clinic handles information shared through this website.", path: "/privacy-policy" });
export default function PrivacyPage() { return <LegalPage title="Privacy" intro="This policy explains how Injectox Clinic handles information shared through this website and how to contact the clinic about your privacy." sections={[
  ...
  { title: "Your rights", copy: "Under UK data-protection law, you may have rights to access, correction, erasure, restriction, objection and portability. To ask a question or exercise a right, email injectoxclinic@gmail.com or write to the clinic at the address below." },
  { title: "Contact the clinic", copy: "Injectox Clinic is based inside Skin Clinic MCR, Unit 36, Waters Edge Business Park, Modwen Road, Salford, Greater Manchester, M5 3EZ. Privacy questions can be sent to injectoxclinic@gmail.com." },
]} />; }
