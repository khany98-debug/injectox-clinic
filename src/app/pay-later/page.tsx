...
export const metadata: Metadata = pageMetadata({ title: "Payment Flexibility", description: "Ask Injectox Clinic about current pay-later options and provider terms.", path: "/pay-later", index: false });
