...
export default function sitemap(): MetadataRoute.Sitemap {
  const base = "https://www.injectoxclinic.co.uk";
  const staticRoutes = ["", "/treatments", "/concerns", "/pricing", "/reviews", "/about", "/faq", "/policies", "/contact", "/gallery", "/packages", "/privacy-policy", "/terms", "/cookies"];
  return [
