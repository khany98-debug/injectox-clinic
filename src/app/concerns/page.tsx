...
export const metadata: Metadata = pageMetadata({ title: "Aesthetic Concerns & Treatment Routes", description: "Find the right aesthetics or skin treatment by starting with the concern you want to address.", path: "/concerns" });
